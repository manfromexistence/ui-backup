...
```bash
npx better-ui@latest add [component]
```
...
```txt
Usage: better-ui add [options] [components...]
...
```txt
Usage: better-ui diff [options] [component]
